...
# Install Apache Web Server and PHPdnf install -y httpd wget php mariadb105-server# Download Lab fileswget  lab-app.zip -d /var/www/html/# Turn on web serverchkconfig httpd onservice httpd start
